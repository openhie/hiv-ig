...
* item[=].item[8].item[0].linkId = "arvTreatment.treatmentHistory"
* item[=].item[8].item[0].text = "ARV Treatment history"
* item[=].item[8].item[0].answer[0].valueString = "161"
* item[=].item[8].item[1].linkId = "arvTreatment.dateOfTreatmentStart"
* item[=].item[8].item[1].text = "Date of treatment start"
* item[=].item[8].item[1].answer[0].valueDate = "2021-03-11"
* item[=].item[8].item[2].linkId = "arvTreatment.dateOfTreatmentStop"
* item[=].item[8].item[2].text = "Date of treatment stop"
* item[=].item[8].item[2].answer[0].valueDate = "2021-03-11"
* item[=].item[8].item[3].linkId = "arvTreatment.placeOfInitiation"
* item[=].item[8].item[3].text = "Place of ARV treatment initiation"
* item[=].item[8].item[3].answer[0].valueString = "164"
* item[=].item[8].item[4].linkId = "arvTreatment.dateOfLossToFollowUp"
* item[=].item[8].item[4].text = "Date of loss to follow up"
* item[=].item[8].item[4].answer[0].valueDate = "2021-03-11"
* item[=].item[8].item[5].linkId = "arvTreatment.dateOfTransferredOut"
* item[=].item[8].item[5].text = "Date ARV treatment transferred out"
* item[=].item[8].item[5].answer[0].valueDate = "2021-03-11"
* item[=].item[8].item[6].linkId = "arvTreatment.placeTransferredOut"
* item[=].item[8].item[6].text = "Place ARV treatment transferred out"
* item[=].item[8].item[6].answer[0].valueString = "167"
* item[=].item[8].item[7].linkId = "arvTreatment.regimen"
* item[=].item[8].item[7].text = "ARV treatment regimen"
* item[=].item[8].item[7].item[0].linkId = "regimen.date1stLineStarted"
* item[=].item[8].item[7].item[0].text = "Date 1st ARV regimen started"
* item[=].item[8].item[7].item[0].answer[0].valueDate = "2021-03-11"
* item[=].item[8].item[7].item[1].linkId = "arvTreatment.date2ndLineStarted"
* item[=].item[8].item[7].item[1].text = "Date 3rd ARV regimen started"
* item[=].item[8].item[7].item[1].answer[0].valueDate = "2021-03-11"
* item[=].item[8].item[7].item[2].linkId = "arvTreatment.date3rdLineStarted"
* item[=].item[8].item[7].item[2].text = "Date 3rd ARV regimen started"
* item[=].item[8].item[7].item[2].answer[0].valueDate = "2021-03-11"
